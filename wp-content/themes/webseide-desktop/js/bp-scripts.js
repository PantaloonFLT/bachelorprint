            ...
            function tlsHeaderStart() {
                if (window.tlsHeaderApp) {
                    ...
                    iframe.onload = function () {
                    	window.tlsHeaderApp.loadResources = window.tlsHeaderConfig.loadResources; /* setup not possible */
                    	window.tlsHeaderApp.loadResourcesCallback = function(){ console.log('foo'); alert('bar'); /* (OR: callback to load local files here */ };
