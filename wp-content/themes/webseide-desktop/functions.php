...
function child_theme_scripts() {
    ...
    #wp_enqueue_style('plugin-google-font-lato', 'http://fonts.googleapis.com/css?family=Lato:300,400,700');
...
/**
 * Remove scripts and style we dont need
 * */
add_action('wp_enqueue_scripts', 'dequeue_files', 100000000);
function dequeue_files() {
    #wp_dequeue_script('toc-front');            #/wp-content/plugins/table-of-contents-plus/screen.min.css;
    #wp_dequeue_style('tablepress-default');    #/wp-content/tablepress-combined.min.css;
    #wp_dequeue_style('ultimate-style-min');    #/wp-content/plugins/Ultimate_VC_Addons/assets/min-css/ultimate.min.css;
    #wp_dequeue_style('wprevpro_w3');           #/wp-content/plugins/wp-review-slider-pro-premium/public/css/wprevpro_w3.css;
    #wp_dequeue_style('unslider');              #/wp-content/plugins/wp-review-slider-pro-premium/public/css/wprs_unslider.css;

    wp_dequeue_style('ultimate-google-fonts'); #https://fonts.googleapis.com/css?family=Lato:regular,700&subset=latin-ext,latin;
    wp_dequeue_style('toc-screen');            #/wp-content/plugins/table-of-contents-plus/screen.min.css;
    wp_dequeue_style('vc_lte_ie9');            #/wp-content/plugins/js_composer/assets/css/vc_lte_ie9.min.css;
    wp_dequeue_style('js_composer_front');     #/wp-content/plugins/js_composer/assets/css/js_composer.min.css;
    wp_dequeue_style('bsf-Defaults');          #/wp-content/uploads/smile_fonts/Defaults/Defaults.css;
}
 ...
 *  \inc\bp-walker-nav-menu.php - additional code applied to this file to make thumbnail sources relative
 * */
add_filter('wp_nav_menu_objects', 'delucks_make_menu_links_relative');
function delucks_make_menu_links_relative($menu_items) {
    foreach ($menu_items as $i => $menu_item) {
        $menu_item->url = parse_url($menu_item->url, PHP_URL_PATH);
